      ...
      def admin_extra_fields
        {
            author: {
                ...
                age_slice: proposal.creator_author[:extended_data].try(:age_slice) || "",
                group_membership: proposal.creator_author[:extended_data].try(:group_membership) || "",
                question_racialized: proposal.creator_author[:extended_data].try(:question_racialized) || "",
                question_gender: proposal.creator_author[:extended_data].try(:question_gender) || "",
                question_sexual_orientation: proposal.creator_author[:extended_data].try(:question_sexual_orientation) || "",
                question_disability: proposal.creator_author[:extended_data].try(:question_disability) || "",
                question_social_context: proposal.creator_author[:extended_data].try(:question_social_context) || ""
            }
        }
      end
    end
